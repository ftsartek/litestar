...
async def subprocess_async_client(
    workdir: pathlib.Path, app: str, capture_output: bool = False
...
@contextmanager
def subprocess_sync_client(workdir: pathlib.Path, app: str, capture_output: bool = False) -> Iterator[httpx.Client]:
